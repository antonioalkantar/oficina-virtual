...
/**
 * The persistent class for the det_vigencia_modalidad_hist database table.
 * 
 */
@Entity
@Table(name="det_vigencia_modalidad_hist", schema = "retys_v2")
@NamedQuery(name="DetVigenciaModalidadHist.findAll", query="SELECT d FROM DetVigenciaModalidadHist d")
public class DetVigenciaModalidadHist implements Serializable {
	...
	private DetVigenciaModalidad detVigenciaMod;

	public DetVigenciaModalidadHist() {
	}
	...
	@OneToOne
	@JoinColumn(name="id")
	public DetVigenciaModalidad getDetVigenciaMod() {
		return detVigenciaMod;
	}


	public void setDetVigenciaMod(DetVigenciaModalidad detVigenciaMod) {
		this.detVigenciaMod = detVigenciaMod;
	}
