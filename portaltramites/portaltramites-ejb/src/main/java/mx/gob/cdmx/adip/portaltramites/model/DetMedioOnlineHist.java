...
/**
 * The persistent class for the det_medio_online_hist database table.
 * 
 */
@Entity
@Table(name = "det_medio_online_hist", schema = "retys_v2")
@NamedQuery(name = "DetMedioOnlineHist.findAll", query = "SELECT d FROM DetMedioOnlineHist d")
public class DetMedioOnlineHist implements Serializable {
	...
	private DetMedioOnline detMedioOnline;

	public DetMedioOnlineHist() {
	}
	...
	@OneToOne
	@JoinColumn(name="id")
	public DetMedioOnline getDetMedioOnline() {
		return detMedioOnline;
	}

	public void setDetMedioOnline(DetMedioOnline detMedioOnline) {
		this.detMedioOnline = detMedioOnline;
	}
