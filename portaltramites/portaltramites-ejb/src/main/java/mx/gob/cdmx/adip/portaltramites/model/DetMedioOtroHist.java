...
/**
 * The persistent class for the det_medio_otro_hist database table.
 * 
 */
@Entity
@Table(name = "det_medio_otro_hist", schema = "retys_v2")
@NamedQuery(name = "DetMedioOtroHist.findAll", query = "SELECT d FROM DetMedioOtroHist d")
public class DetMedioOtroHist implements Serializable {
	...
	private DetMedioOtro detMedioOtro;

	public DetMedioOtroHist() {
	}
	...
	@OneToOne
	@JoinColumn(name = "id")
	public DetMedioOtro getDetMedioOtro() {
		return detMedioOtro;
	}

	public void setDetMedioOtro(DetMedioOtro detMedioOtro) {
		this.detMedioOtro = detMedioOtro;
	}
