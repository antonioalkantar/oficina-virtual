...
/**
 * The persistent class for the det_documento_modalidad_hist database table.
 * 
 */
@Entity
@Table(name="det_documento_modalidad_hist", schema = "retys_v2")
@NamedQuery(name="DetDocumentoModalidadHist.findAll", query="SELECT d FROM DetDocumentoModalidadHist d")
public class DetDocumentoModalidadHist implements Serializable {
	...
	public DetDocumentoModalidadHist() {
	}
